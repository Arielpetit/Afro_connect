    ...
    const plans = [
      {
        ...
        price: 29,
        duration: "mois",
        description: "Meilleure option pour un usage personnel et votre prochain projet.",
        features: [
      ...
      },
      {
        ...
        price: 99,
        duration: "mois",
        description: "Idéal pour plusieurs utilisateurs, avec support étendu et premium.",
        features: [
          "Configuration individuelle",
          "Aucun frais d'installation ou caché",
        ...
        <div className="max-w-screen-xl px-4 py-16 mx-auto lg:py-24 lg:px-6">
          ...
          <div className="mt-12 text-center">
            <p className="text-gray-500 dark:text-gray-400 text-sm">
              ...
              <a href="#" className="text-purple-500 hover:underline">Contactez notre équipe</a>
            </p>
          </div>
        </div>
      </section>

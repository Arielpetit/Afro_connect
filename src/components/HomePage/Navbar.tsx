...
export function Navbar() {
  ...
  return (
    <nav className="bg-white shadow-sm fixed w-full z-50">
      ...
      {/* Mobile Sidebar Menu */}
      {/* Mobile Sidebar Menu - Remove Home and Profile links from here */}
      <div
      ...
      >
        <div className="flex flex-col p-4 space-y-4">
          ...
          {user && (
            <NavLink
              to="/register"
              className="bg-blue-600 text-white px-6 py-2.5 rounded-full font-medium text-sm hover:bg-blue-700 transition-colors text-center"
              onClick={toggleMenu}
            >
              Enregistrez-vous
            </NavLink>
          ...
          <NavLink
            to="/admin-login"
            className="bg-green-600 text-white px-6 py-2.5 rounded-full font-medium text-sm hover:bg-green-700 transition-colors text-center"
            onClick={toggleMenu}
          >
            Admin
          </NavLink>
          {user && (
            <NavLink
              ...
              onClick={toggleMenu}
            >
              <UserCheck className="inline-block w-5 h-5 mr-2" /> profile
              personelle
            </NavLink>
          )}
        </div>
